...
with coluna2:
    view_state = pdk.ViewState(
        latitude=float(latitude[0]), # float 32 deu problema! porém, podemos converter float
        longitude=float(longitude[0]), # float 32 deu problema! porém, podemos converter float
        zoom=5,
        min_zoom=5,
        max_zoom=15,
    )
